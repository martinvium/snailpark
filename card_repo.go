...
var CardRepo = []*CardProto{
	...
	NewSpellProto("Goo-to-the-face", 1, "Deal 5 damage to target player -- That's not nice.", NewPlayerDamageAbility(5)),
	NewSpellProto("Awkward conversation", 1, "Deal 3 damage to target creature or player", NewDamageAbility(5)),
